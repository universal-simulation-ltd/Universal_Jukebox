...
// light until chosen). Settings ▸ Appearance and the menu's App preferences
// both set it, through this one store, so they always agree.
//
// ⚠️ The key is every user's saved choice. Renaming it silently puts them all
// back to following global.
export type { ThemePref }

export const useThemeStore = createThemeStore('unisim-jukebox-theme')
